...
plot(times,ci[2,1:12],type='n', ylab="Chl-a", ylim = c(min(ci[1,1:12]),max(ci[3,1:12])),main="Obs, Latent CI (blue), PI (green), Obs PI (grey)")
ciEnvelope(times,ci[1,1:12],ci[3,1:12],col="lightBlue")
ciEnvelope(times,obs_pi[1,],obs_pi[3,],col="gray")
ciEnvelope(times,pi[1,],pi[3,],col="Green")
points(times,y[9,1:12],pch="+",cex=0.8)
